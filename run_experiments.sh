...
CUDA_VISIBLE_DEVICES=0 python main.py --env half_cheetah --ensemble-size 5 --activation relu --expert-demos False > relu.out &
CUDA_VISIBLE_DEVICES=1 python main.py --env half_cheetah --ensemble-size 5 --activation swish --expert-demos False > swish.out &
